...
namespace SRL.MonoGameControl
{
    public static class DrawHelper
    {
        ...
        private static List<Point> CreateArc(float radius, int sides, float startingAngle, float radians)
        {
        ...
        /// <param name="color">The color to draw the rectangle in</param>
        public static void FillRectangle(this SpriteBatch spriteBatch, Point location, Point size, Color color)
        {
        ...
        /// <param name="angle">The angle in radians to draw the rectangle at</param>
        /// <param name="color">The color to draw the rectangle in</param>
        public static void FillRectangle(this SpriteBatch spriteBatch, Point location, Point size, Color color, float angle)
        {
            if (pixel == null)
            {
                CreateThePixel(spriteBatch);
        ...
        {
            FillRectangle(spriteBatch, new Point(x, y), new Point(w, h), color, 0.0f);
        }
        ...
        {
            FillRectangle(spriteBatch, new Point(x, y), new Point(w, h), color, angle);
        }
        ...
        public static void DrawRectangle(this SpriteBatch spriteBatch, Rectangle rect, Color color, float thickness)
        {
            ...
            DrawLine(spriteBatch, new Point(rect.X, rect.Y), new Point(rect.Right, rect.Y), color, thickness); // top
            DrawLine(spriteBatch, new Point(rect.X + 1f, rect.Y), new Point(rect.X + 1f, rect.Bottom + thickness), color, thickness); // left
            DrawLine(spriteBatch, new Point(rect.X, rect.Bottom), new Point(rect.Right, rect.Bottom), color, thickness); // bottom
            DrawLine(spriteBatch, new Point(rect.Right + 1f, rect.Y), new Point(rect.Right + 1f, rect.Bottom + thickness), color, thickness); // right
        }
        ...
        /// <param name="size">The size of the rectangle</param>
        /// <param name="color">The color to draw the rectangle in</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, Point location, Point size, Color color)
        {
        ...
        public static void DrawRectangle(this SpriteBatch spriteBatch, Point location, Point size, Color color, float thickness)
        {
        ...
        {
            DrawLine(spriteBatch, new Point(x1, y1), new Point(x2, y2), color, 1.0f);
        }
        ...
        {
            DrawLine(spriteBatch, new Point(x1, y1), new Point(x2, y2), color, thickness);
        }
        ...
        /// <param name="color">The color to use</param>
        public static void DrawLine(this SpriteBatch spriteBatch, Point point1, Point point2, Color color)
        {
        ...
        /// <param name="color">The color to use</param>
        /// <param name="thickness">The thickness of the line</param>
        public static void DrawLine(this SpriteBatch spriteBatch, Point point1, Point point2, Color color, float thickness)
        {
            // calculate the distance between the two vectors
            float distance = Vector2.Distance(new Vector2((float)point1.X, (float)point1.Y), new Vector2((float)point2.X, (float)point2.Y));
        ...
        /// <param name="color">The color to use</param>
        public static void DrawLine(this SpriteBatch spriteBatch, Point point, float length, float angle, Color color)
        {
        ...
        public static void DrawCircle(this SpriteBatch spriteBatch, Point center, float radius, int sides, Color color)
        {
        ...
        public static void DrawCircle(this SpriteBatch spriteBatch, Point center, float radius, int sides, Color color, float thickness)
        {
        ...
        {
            DrawPoints(spriteBatch, new Point(x, y), CreateCircle(radius, sides), color, 1.0f);
        }
        ...
        {
            DrawPoints(spriteBatch, new Point(x, y), CreateCircle(radius, sides), color, thickness);
        }
        ...
        public static void DrawArc(this SpriteBatch spriteBatch, Point center, float radius, int sides, float startingAngle, float radians, Color color)
        {
        ...
        public static void DrawArc(this SpriteBatch spriteBatch, Point center, float radius, int sides, float startingAngle, float radians, Color color, float thickness)
        {
            List<Point> arc = CreateArc(radius, sides, startingAngle, radians);
            //List<Point> arc = CreateArc2(radius, sides, startingAngle, degrees);
